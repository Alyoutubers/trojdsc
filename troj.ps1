...
Function LAN{
param ([string]$Prefix)
    if ($Prefix.Length -eq 0){Write-Output "Utiliser -prefix pour définir les trois premières parties d'une adresse IP, par exemple : LAN -prefix 192.168.1";sleep 1 ;return}
...
$infomessage1 = "``````
=============================================================
INFORMATIONS SYSTÈME POUR $env:COMPUTERNAME
=============================================================
...
Disposition du Clavier  : $keyboardLayoutID
Autres Comptes          : $users
Système d'Exploitation  : $OSString
ID de Build             : $ver
Architecture            : $OSArch
...
Informations Réseau
-------------------------------------------------------------
Adresse IP Publique     : $computerPubIP
``````"
$infomessage2 = "
...
==================================================================================================================================
Informations sur les Modifications Récentes de Fichiers
----------------------------------------------------------------------------------------------------------------------------------
$RecentFiles
...
==================================================================================================================================
Informations sur les Processus Actuels
----------------------------------------------------------------------------------------------------------------------------------
$process
=================================================================================================================================="
